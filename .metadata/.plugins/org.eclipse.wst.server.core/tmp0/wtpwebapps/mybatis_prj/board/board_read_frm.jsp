...
<c:redirect url="http://192.168.10.216/mybatis_prj/index.jsp"/>
</c:if>
...
<!--bootstrap끝-->
<link rel="stylesheet" href="http://192.168.10.216/mybatis_prj/common/css/main.css" media="all" />
...
<style type="text/css">
	...
	#header{height:100px; background:#FFFFFF url('http://192.168.10.216/mybatis_prj/common/images/header.png') no-repeat;}
...
<script type="text/javascript">
	$(function(){
	    $("#btnList").click(function () {
	        //history.back();
	        location.href="http://192.168.10.216/mybatis_prj/board/board_list.jsp?currentPage=${param.currentPage}";
	    });//click
...
BoardDAO bDAO=BoardDAO.getInstance();
	try{
	  ...
	  BoardDomain bVO=bDAO.selectDetailBoard(Integer.parseInt(seq));//상세보기
...
%>
	  ...
	  %>
	  <script type="text/javascript">
	location.href="http://192.168.10.216/mybatis_prj/error/err_500.html";
</script>
	  <%
	}
%>
	...
	<tr>
		...
		<%-- <c:if test="${ bVO.id eq sessionScope.loginData.id }"><!-- 내 글만 수정 삭제 가능 --> --%>
