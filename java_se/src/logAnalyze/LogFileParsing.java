...
public class LogFileParsing {
    ...
    public LogDataAnalyze getLogDataAnalyze() {
        return logAnalyze;
    }

    public LogDataAnalyze getCustomLogDataAnalyze() {
    ...
    public void customizedParsing(int start, int end) throws IOException, IllegalArgumentException {
        if (start > end) {
            throw new IllegalArgumentException("입력한 시작 라인 숫자가 끝 라인 숫자보다 큽니다.");
        }
