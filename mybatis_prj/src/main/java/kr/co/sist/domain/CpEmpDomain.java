...
public class CpEmpDomain {
  ...
  public CpEmpDomain(int empno, int sal, int comm, int deptno, String ename, String hiredateStr, String job,
      Date hiredate) {
    System.out.println("매개변수 있는 CpEmpDomain 기본생성자");
    // super();
    this.empno = empno;
    this.sal = sal;
    this.comm = comm;
  ...
  public void setEname(String ename) {
    System.out.println("setEname 설정 값" + ename);
    this.ename = ename;
  }
  ...
  public String toString() {
    return "CpEmpDomain [empno=" + empno + ", sal=" + sal + ", comm=" + comm + ", deptno=" + deptno + ", ename=" + ename
        + ", hiredateStr=" + hiredateStr + ", job=" + job + ", hiredate=" + hiredate + "]";
  }
