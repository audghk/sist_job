...
<div id="content">
	...
	%>
<jsp:useBean id="sVO" class="kr.co.sist.user.board.SearchVO" scope="page"></jsp:useBean>
<jsp:setProperty property="*" name="sVO"/>
	...
	try{
		    ...
		    */
		    ...
		    List<BoardVO> list=bDAO.selectBoard(sVO);//시작번호와 끝 번호 사이의 글 조회
	...
	%>
	   ...
	   <div>
	    <input type="button"  value="글쓰기" id="btnWrite" class="btn btn-info btn-sm"/>
	    <table class="table">
	    	<thead>
	    	<tr>
	    		<th class="num">번호</th>
