...
<label>text</label>
<input type="text" name="txt" value="GET연습"><br/><!-- test할 때 value 넣어놓고 서비스할 때는 빼면 됨 -->
...
<select name="loc">
	...
	<option value="충청남북도" selected="selected">충청남북도</option>
	<option value="경상남북도">경상남북도</option>
	<option value="전라남북도">전라남북도</option>
	<option value="제주도">제주도</option>
</select>
<label>textarea</label>
<textarea style="width:300px; height:100px" name="ta">TextArea 연습</textarea>
<br/>
<label>이름</label>
...
<select name="loc">
	<option value="서울시">서울</option>
	<option value="경기도">경기도</option>
	<option value="충청남북도">충청남북도</option>
	<option value="경상남북도">경상남북도</option>
	<option value="전라남북도">전라남북도</option>
