...
<div id="wrap">
	<div id="memberDiv">
	<a href="http://192.168.10.216/jsp_prj/member/${ url }" class="memberLink"><c:out value="${ sessionScope.loginData.name }${ pageScope.title }"/></a>
	<a href="http://192.168.10.216/jsp_prj/member/member_join_frm.jsp" class="memberLink">회원가입</a>
	<a href="http://localhost/jsp_prj/board/board_list.jsp" class="memberLink">게시판</a>	
	</div>
