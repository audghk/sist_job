 ...
 * - 반드시 instance화 후에 사용되어야한다. (동일 영역에서는 객체명을 생략하고 사용할 수 있다.)
 */
...
//	private int c;
	...
	public static void main(String[] args) {
		...
		//객체화 - 인스턴스 변수를 사용하기 위해서 객체화를 한다.
		//클래스명 객체명=new 클래스명();
		//i라는 변수를 사용하기 위해 UseInstanceVariable 클래스를 객체화 한다.
		...
		System.out.println("문자 : " + uiv.b + " 문자 : " + (int)uiv.b);
