...
<style type="text/css">
	...
	#get{width:398px;height:398px;float:left; border:1px solid #333}
	#post{width:398px;height:398px;float:right; border:1px solid #333}
...
<div id="wrap">
	<div id="get">
		...
		<ul>
			...
			<li>
			<form action="call.jsp" method="get" id="frmGet"><!-- method 속성은 get이 기본값 -->
	...
	<div id="post">
		<h3>POST방식으로 JSP 요청!!!</h3>
			<form action="call.jsp" method="post" id="frmPost"><!-- method 속성은 get이 기본값 -->
				<input type="text" value="text" id="text"/><br>
				<!-- <input type="submit" value="form 요청" id="btnGet"/> -->
