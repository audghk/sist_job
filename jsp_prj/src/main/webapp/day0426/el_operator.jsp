...
<body>
<div>
<h3>EL에서 사용 가능한 연산자</h3>
<%
	int i=4;
	boolean flag=false;
	String s=null;
	String s2="";//String s2=new String();
	List<String> list=new ArrayList<String>();
	//EL에서 변수를 사용하려면 scope객체에 할당하고, scope객체명으로 변수를 사용.
...
<li>${ i } &gt;= 4 = ${ i>=4 }(${i ge 4 })</li>
<li>${ i } &lt;= 4 = ${ i<=4 }(${i le 4 })</li>
<li>${ i } == 4 = ${ i==4 }(${i eq 4 })</li>
<li>${ i } == 5 = ${ i==5 }(${i eq 5 })</li>
<li>${ i } != 5 = ${ i!=5 }(${i ne 5 })</li>
<li>${ i } != 4 = ${ i!=4 }(${i ne 4 })</li>
<li>논리</li>
<li>${ i } > 0 && ${ i } &lt; 10 = ${i>0 && i<10}(${ i gt 0 and i lt 10 })</li>
<li>${ i } > 0 || ${ i } &lt; 10 = ${i>0 || i<10}(${ i gt 0 or i lt 10 })</li>
<li>삼항</li>
<li>${ i }는 ${ i%2==0?"짝수":"홀수"}(${ i mod 2 eq 0?'짝수':'홀수'})</li>
<li>empty</li>
<li>null은 출력하지 않는다. (${ empty s }) <%= s %></li>
<li>""도 출력하지 않는다. (${ empty s2 })</li>
<li>list size가 0인 경우. (${ empty list })</li>

</ul>
	<%-- ${ i<<2 } 위에 사용한 연산자 이외의 연산자는 사용할 수 없다. --%>
</div>
</body>
</html>