 ...
 * Generated at: 2024-05-13 00:41:02 UTC
...
public final class search_005fmap_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("	</style>\r\n");
      out.write("	<script type=\"text/javascript\" src=\"//dapi.kakao.com/v2/maps/sdk.js?appkey=4506f540cd66a1dbc8c0db892eba6582\"></script>\r\n");
      out.write("	<script text=\"text/javascript\">\r\n");
      out.write("		$(function(){\r\n");
      out.write("			$(\"#btn\").click(function(){\r\n");
      out.write("				$.ajax({\r\n");
      out.write("					url: \"search_restaurant.jsp\",\r\n");
      out.write("					type: \"GET\",\r\n");
      out.write("					dataType: \"JSON\",\r\n");
      out.write("					error: function(xhr){\r\n");
      out.write("						alert(\" 문제 발생 ! \");\r\n");
      out.write("						console.log(\"에러코드 : \" + xhr.status + \" /  에러 메세지 : \" + xhr.statusText);\r\n");
      out.write("					},\r\n");
      out.write("					success: function(jsonObj){\r\n");
      out.write("						console.log(jsonObj.data);\r\n");
      out.write("					}\r\n");
      out.write("				});\r\n");
      out.write("			});\r\n");
      out.write("		});\r\n");
      out.write("		\r\n");
      out.write("		//조회결과로 table에 데이터를 동적생성\r\n");
      out.write("		function setTable(jsonObject){\r\n");
      out.write("			\r\n");
      out.write("			var output=\"<tr>\";\r\n");
      out.write("			$.each(jsonObject.data, function(i, jsonObj){\r\n");
      out.write("				output += `<tr><td>${(i+1)}</td>\r\n");
      out.write("						   <td>${jsonObj.name}(${jsonObj.lat},${jsonObj.lng})</td>\r\n");
      out.write("						   <td>${jsonObj.menu}</td>`;				\r\n");
      out.write("			});\r\n");
      out.write("			\r\n");
      out.write("			output+=\"</tr>\";\r\n");
      out.write("			\r\n");
      out.write("			//기존 데이터를 삭제하고\r\n");
      out.write("			$(\"#dataTbody\").empty();\r\n");
      out.write("			//새로운 데이터를 보여준다.\r\n");
      out.write("			$(\"#dataTbody\").append(output);\r\n");
      out.write("		}\r\n");
      out.write("	</script>\r\n");
      out.write("	<script>\r\n");
      out.write("		var positions = [\r\n");
      out.write("			{\r\n");
      out.write("		        title: '쌍용교육센터', \r\n");
      out.write("		        latlng: new kakao.maps.LatLng(37.4993366,127.0332123)\r\n");
      out.write("		    }\r\n");
      out.write("		];\r\n");
      out.write("		\r\n");
      out.write("		$(function(){\r\n");
      ...
      out.write("		    mapOption = { \r\n");
      out.write("				center: new kakao.maps.LatLng(37.4993366,127.0332123), // 지도의 중심좌표\r\n");
      ...
      out.write("	<input type=\"button\" value=\"맛집보기\" id=\"btn\" class=\"btn btn-success btn-sm\" />\r\n");
      out.write("	<div>\r\n");
      out.write("		<table id=\"tab\" class=\"table\">\r\n");
      out.write("			<thead>\r\n");
      out.write("				<tr>\r\n");
      out.write("					<th style=\"width: 80px\">번호</th>\r\n");
      out.write("					<th style=\"width: 200px\">식당명</th>\r\n");
      out.write("					<th style=\"width: 500px\">메뉴</th>\r\n");
      out.write("				</tr>\r\n");
      out.write("			</thead>\r\n");
      out.write("			<tbody id=\"dataTbody\"></tbody>\r\n");
      out.write("		</table>\r\n");
      out.write("	</div>\r\n");
      out.write("</div>\r\n");
      out.write("</body>\r\n");
