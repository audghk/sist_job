...
public class EmailSender {
  ...
  public void mailSend(EmailVO eVO)
    ...
    try {
      FileInputStream fis =
          new FileInputStream(System.getProperty("user.dir") + "/src/main/java/properties/email.properties");
    ...
    props.put("mail.smtp.host", "smtp.naver.com");// SMTP서버의 호스트 명 설정 smtp.naver.com
    ...
    try {
      // 메시지 구성
      // MimeMessage : 메시지의 헤더 설정 - 발신자, 수신자, 제목, 내용 - 메타데이터를 설정
  ...
  public static void main(String[] args)
    ...
    EmailVO eVO = new EmailVO(0, "cpfl688@naver.com", "냠냠", "뇸뇸");
    e.mailSend(eVO);
  }
